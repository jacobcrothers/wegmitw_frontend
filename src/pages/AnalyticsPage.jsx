...
const Analytics = () => {
  ...
  const contentData = useMemo(() => {
    ...
    console.log(overviewData.buyerNum24h === undefined);
    return (
      <>
                      ...
                      <div className="col-lg-4">
                        <div className="overview-box-item bg-2c254a">
                          <span className="d-block">
                            Market Sentiment{" "}
                            <i className="fas fa-info-circle ml-2">{Math.ceil(overviewData.holderNumChange24h * 10000)}</i>
                          </span>
                        </div>
                      </div>
                      <div className="col-lg-4">
                          ...
                          <div className="static-con w-100 float-left">
                            <ul className="list-unstyled mb-0 p-0 border-0">
                              <li className="float-left border-0">
                                ...
                                <h5 className="mb-0 text-white">{overviewData.buyerNum24h}</h5>
                              </li>
                              <li className="float-right text-end">
                                <span className="pr-0">Sellers</span>
                                <h5 className="mb-0 text-white">{overviewData.sellerNum24h}</h5>
                              </li>
                            </ul>
                          </div>
                        </div>
                          ...
                          <div className="static-con w-100 float-left">
                            <ul className="list-unstyled mb-0 p-0 border-0">
                              <li className="float-left border-0">
                                ...
                                <h5 className="mb-0 text-white">{overviewData.pnlPositive}</h5>
                              </li>
                              <li className="float-right text-end">
                                <figure>
                                  <img
                                ...
                                <h5 className="mb-0 text-white">{overviewData.pnlNegative}</h5>
                              </li>
                            </ul>
                          </div>
                        </div>
